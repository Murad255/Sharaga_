  ...
  if (toggleButton != null && toggleButton != undefined && content != null && content != undefined) {
    ...
    if (collapsed) {
      ...
      if (toggleButton.src != null && toggleButton.src != undefined) {
        var baseDir = '';
        var baseDirLength = toggleButton.src.lastIndexOf('/');
        if (baseDirLength >= 0)
          baseDir = toggleButton.src.substring(0, toggleButton.src.lastIndexOf('/') + 1);

        var extension = '';
        var extensionLength = toggleButton.src.lastIndexOf('.');
        if (extensionLength >= 0)
          extension = toggleButton.src.substring(extensionLength);
